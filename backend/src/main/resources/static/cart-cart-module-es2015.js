...
const routes = [{ path: '', component: _containers_cart_list_cart_list_component__WEBPACK_IMPORTED_MODULE_2__["CartListComponent"] }];
...
let CartTableComponent = class CartTableComponent {
    constructor() {
...
let CartListComponent = class CartListComponent {
    constructor(cartDataService, dialog, orderService, snackBar, currencyPipe) {
    ...
    onDelete(id) {
        const dialog = this.dialog.open(_shared_components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"], {
            data: {
    ...
    onQuantityChange({ id, quantity }) {
        const dialog = this.dialog.open(_shared_components_number_picker_dialog_number_picker_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NumberPickerDialogComponent"], {
            data: quantity
        });
        dialog.afterClosed().subscribe(result => {
            if (result) {
    ...
    onCheckout() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.dataSource$)
            ...
            .subscribe(item => {
            const dialogRef = this.dialog.open(_components_customer_info_customer_info_component__WEBPACK_IMPORTED_MODULE_7__["CustomerInfoComponent"], {
                width: '30%',
                height: '80%'
            });
...
let OrderService = class OrderService {
    ...
    getOrders() {
        return this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + 'all').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((receivedData) => { receivedData; }));
    }
    placeOrder(data) {
    ...
    getOrderById(orderId) {
        return this.httpClient.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + this.serviceAction + '/', orderId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((receivedData) => { receivedData; }));
    }
};
